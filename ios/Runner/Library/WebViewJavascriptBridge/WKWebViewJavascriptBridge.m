...
- (void)registerHandler:(NSString *)handlerName handler:(WVJBHandler)handler {
    ...
    if (![self.registMethodsArrayM containsObject:handlerName]) {
        [self.registMethodsArrayM addObject:handlerName];
    }
}
...
{
   // Log(@"*********sendToJS %@",javascriptCommand);
    [_webView evaluateJavaScript:javascriptCommand completionHandler:nil];
    return NULL;
}


- (NSMutableArray *)registMethodsArrayM
{
    if (_registMethodsArrayM == nil) {
        _registMethodsArrayM = [NSMutableArray array];
    }
    return _registMethodsArrayM;
}
@end
